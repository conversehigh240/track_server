...
class Audio2ContentVec():
    def __init__(self, path, h_sample_rate=16000, h_hop_size=320, device='cuda'):
        self.device = device
...
class CNHubertSoftFish(torch.nn.Module):
    def __init__(self, path, h_sample_rate=16000, h_hop_size=320, device='cuda', gate_size=10):
        super().__init__()
        self.device = device
